    ...
    members: [
      {
        ...
        bio: "Two decades leading enterprise transformation across construction, infrastructure, and aviation — including 40+ legacy systems replaced at Sir Robert McAlpine.",
        photo: "/images/1713961688549.jpg",
        initials: "OK",
      },
      {
        name: "Callum Campbell",
        role: "Head of FS & AI Engagement",
        rolePill: "Engagement lead",
        bio: "Leads SmartCo's financial services and AI engagements — the bridge between today's session and what it means commercially for MUFG.",
      ...
      },
      {
        ...
        bio: "25+ years delivering programmes and data platforms for the world's largest banks — RBS, HSBC, Barclays, LSEG, and the FCA.",
