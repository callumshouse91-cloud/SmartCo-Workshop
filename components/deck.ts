...

  {
    ...
    members: [
      ...
      },
      {
        ...
        bio: "Leads SmartCo's financial services and AI engagements — proposal shaping, AI-led operating models, and regulatory readiness. The bridge between today's session and what it means commercially for MUFG.",
      ...
      },
      {
        ...
        bio: "25+ years delivering programmes and data platforms for the world's largest banks — RBS, HSBC, Barclays, LSEG, the FCA. Now certified in AI risk and governance.",
